...
\\begin{document}
\\title{%s Chip-Seq QC Report Version 1}
\\author {DC group}
\\vspace{-1cm}
\maketitle
...
{\includegraphics[width=0.72\\textwidth]{%s}}
\end{center}
\end{figure}
\\newpage
<dhs_qc_tex>
...
\setlength{\\belowcaptionskip}{10pt}
\centering
{\includegraphics[width=0.9\\textwidth]{verlcro_rates.pdf}}
\end{figure}
\\newpage
<velcro_qc_tex>
