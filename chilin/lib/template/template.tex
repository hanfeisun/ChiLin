...
The sequence quality score listed in the table allows you to see if a subset of your sequences have universally low quality values. Here we can report the sequence quality scores of the new datasets and use our criteria to judge the quality of the new raw data(Table ~\ref{fastqctable}).\\
\end{quotation}
\begin{table}[h]
...
Unique reads ratio: percentage of unique mappable reads in mappable reads. The bigger the percentage is, the better.(Table ~\ref{basicqc})
\end{quotation}
\begin{table}[h]
...
For the column of 'peaks $\geq$ 10FC', it shows that the number of peaks that require the fold enrichment of tags locate on the genome $\geq$ 10. The log value can give us more confidence in our data.
...
\setlength{\belowcaptionskip}{10pt}
\centering
{\includegraphics[width=0.9\textwidth]{\VAR{high_confident_peak_graph}}}
\end{figure}
\newpage
...
We draw a CDF curve of the overlap with Non-verlcro region of all DC data, then we can assess the confidence level of  the TF binding sites described by your peak file. (Figure: ~\ref{fig:velcro})
\end{quotation}
\begin{figure}[h] 
...
\setlength{\belowcaptionskip}{10pt}
\centering
{\includegraphics[width=0.8\textwidth]{\VAR{velcro_ratio_graph}}}
\end{figure}
\newpage
%- endif
...
\begin{figure}[h]
        ...
        \setlength{\belowcaptionskip}{10pt}
        \centering
        {\includegraphics[width=0.8\textwidth]{\VAR{venn_graph}}}
\end{figure}
\newpage
...
\begin{figure}[h]
        ...
        \setlength{\belowcaptionskip}{10pt}
        \centering
        {\includegraphics[width=0.8\textwidth]{\VAR{correlation_graph}}}
\end{figure}
\newpage
%- endif
%- endif
...
\begin{figure}[h] 
        ...
        \centering
        {\includegraphics[width=0.9\textwidth]{\VAR{meta_gene_graph}}}
\end{figure}
\newpage
...
\begin{figure}[h] 
        ...
        \setlength{\belowcaptionskip}{10pt}
        \centering
        {\includegraphics[width=0.8\textwidth]{\VAR{conservation_compare_graph}}}
\end{figure}
\newpage
...
*\VAR{line.motif|join(' ')} & \VAR{line.Zscore} & \VAR{line.hits} & \includegraphics[angle=0,width=0.28\textwidth]{\VAR{line.logo}} \\
%#\VAR{line|join(' & ')} \\
\hline
\BLOCK{ endfor }
\end{tabularx}
